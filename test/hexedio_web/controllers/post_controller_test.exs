defmodule HexedioWeb.PostControllerTest do
  use HexedioWeb.ConnCase

  alias Hexedio.Posts

  @create_attrs %{content: "some content", date_published: ~D[2010-04-17], excerpt: "some excerpt", published: true, slug: "some slug", title: "some title"}
